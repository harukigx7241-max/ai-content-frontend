...
def get_kpi(db: Session) -> dict:
    ...
    try:
        ...
        logger.debug("logins_today 取得スキップ: %s", e)
    ...
    try:
        ...
        logger.debug("community posts 取得スキップ: %s", e)
    ...
    try:
        ...
        logger.debug("xp_events 取得スキップ: %s", e)
    ...
    try:
        ...
        logger.debug("invites 取得スキップ: %s", e)
...
def log_audit(
    ...
    try:
        ...
        logger.warning("audit_log書き込み失敗 (action=%s): %s", action, e)
...
def get_improvement_candidates(db: Session) -> dict:
    ...
    try:
        ...
        logger.warning("get_improvement_candidates失敗: %s", e)
    return {
